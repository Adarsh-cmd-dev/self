    ...
    public partial class Subject : System.Web.UI.Page
    {
        ...
        private void GetSubject()
        {
            DataTable dt = fn.Fetch(@"select Row_NUMBER() over(order by (select 1)) as [Sr. No], 
                                    s.SubjectId, s.ClassId, c.ClassName, s.SubjectName from Subject s inner join Class c on c.ClassId = s.ClassId");
        ...
        protected void GridView1_RowUpdating(object sender, GridViewUpdateEventArgs e)
        {
            try
            {
                ...
                string subjName = (row.FindControl("txtSubjectEdit") as TextBox).Text;
