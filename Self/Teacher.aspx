<%@ Page Language="C#" AutoEventWireup="true" CodeBehind="Teacher.aspx.cs" Inherits="Self.Teacher" %>
...
<body>
    <form id="form1" runat="server">
        <div class="container p-md-4 p-sm-4">
            ...
            <h3><%--<a class="text-muted" href="Changepassword.aspx">Change password?</a>--%>
                 <asp:LinkButton ID="lnk_changepassword" runat="server"   
        onclick="lnk_changepassword_Click">Change Password</asp:LinkButton> 
            </h3>
            <div class="col-md-3 col-md-offset-2 mb-3" style="padding-right: 185px;">
                        <asp:LinkButton ID="btnLogOut" runat="server" CausesValidation="false" CssClass="btn btn-primary btn-block" BackColor="#5558c9" OnClick="btnLogOut_Click">Logout</asp:LinkButton>
                    </div>
             ...
             <div class="row mb-3 mr-lg-5 ml-lg-5">
                <div class="col-md-12">
                    <asp:GridView ID="GridView1" runat="server" CssClass="table table-hover table-bordered" EmptyDataText="No record to display!" 
                        AutoGenerateColumns="False" OnPageIndexChanging="GridView1_PageIndexChanging" OnRowCancelingEdit="GridView1_RowCancelingEdit" DataKeyNames="TeacherId"
